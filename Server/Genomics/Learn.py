...
def fetch_shap_results(date_time, tissue, genome_version, row_num):
    ...
    cluster_output_path = "./PathoSearch/ML-Scripts/SHAP_Output/{}_{}_{}_shap_output.jpg".format(date_time, tissue, row_num)
